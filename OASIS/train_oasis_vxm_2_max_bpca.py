...
from models import VxmDenseMaxBPCA_2
import random
import time
...
def main():
    batch_size = 1
    train_dir = "datasets/OASIS/All/"
    val_dir = "datasets/OASIS/Test/"
    weights = [1, 1]  # loss weights
    save_dir = "vxm_2_max_bpca_mse_{}_diffusion_{}/".format(weights[0], weights[1])
    ...
    Initialize model
    """
    model = VxmDenseMaxBPCA_2(img_size)
    model.cuda()
    ...
    val_set = datasets.OASISBrainInferDataset(
    ...
    for epoch in range(epoch_start, max_epoch):
        ...
        for data in train_loader:
            ...
            loss_mse = criterion_mse(output, y) * weights[0]
            ...
            loss_mse = criterion_mse(output, x) * weights[0]
        ...
        print(
            f"End epoch {epoch}, time taken: {step_end_epoch_time - step_start_epoch_time} seconds"
        )
