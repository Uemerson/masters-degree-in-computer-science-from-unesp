...
def main():
    ...
    train_dir = 'datasets/IXI_data/Train/'
    val_dir = 'datasets/IXI_data/Val/'
    ...
    if cont_training:
        ...
        best_model = torch.load(
            model_dir + natsorted(os.listdir(model_dir))[-3])['state_dict']
    ...
    train_set = datasets.IXIBrainDataset(
        glob.glob(train_dir + '*.pkl'), atlas_dir, transforms=train_composed)
